      ...
      <Container>
        ...
        <Row className="justify-content-md-center">
          <Alert variant="secondary">
            ...
            I am starting to get the hang of it and it's fun. The code for this site is on my github at <a href="https://github.com/tracepowers/personal-website"> this link</a>. My personal
